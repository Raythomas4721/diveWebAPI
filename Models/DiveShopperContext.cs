...
public partial class diveShopperContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TNcartItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.TNcartItems)
                .HasForeignKey(d => d.MemberId)
                .HasConstraintName("FK_tNcartItem_tMmemberList");
        ...
        modelBuilder.Entity<TSorder>(entity =>
        {
            ...
            entity.Property(e => e.SiteTime).HasColumnName("siteTime");
